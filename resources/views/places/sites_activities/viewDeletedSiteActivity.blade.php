...
@section('content_header')
    ...
    <div class="col-sm-6">
        <h1 class="m-0">Sites Activities\Deleted</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item"><a href="{{route('sites_activities.index')}}">Sites Activities</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="deletedSitesActivitiesTable"
...
<!-- /.content -->
@include('places.sites_activities.forceDeleteSiteActivityModal')
@endsection
@section("Js_Page")
    @include('places.sites_activities.deletedSiteActivityJS')
@endsection
