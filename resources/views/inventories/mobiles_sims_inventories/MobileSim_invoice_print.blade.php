    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
                To
                <address>
                    <strong>MR:{{$employee->emp_name}}</strong><br>
                </address>
            </div>
            <!-- /.col -->
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <p class="lead">3- I'm responsible for return it upon request or when leaving work.</p><br>
                <p class="lead">4- I will pay for any damages happened to it.</p><br>
            </div>
            <!-- /.col -->
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <p class="lead">By signing this argeement,the client responsibility(for his\her device) to demonstrate proper use of specified equipment.
                    Client also understand that this device is for business usage only.
