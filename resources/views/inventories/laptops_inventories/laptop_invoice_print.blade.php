            ...
            <div class="col-12 table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            Screen size: {{$laptop->screen_inch}} inch<br>
                            CPU: {{$laptop->cpu_name}}<br>
                            GPU1: {{$laptop->gpu1_name}}<br>
                            GPU2: {{$laptop->gpu2_name}}<br>
                            RAM: {{$laptop->ram}}<br>
                            HDD Hard: {{$laptop->hdd_storage}} GB<br>
                            SSD Hard: {{$laptop->ssd_storage}} GB<br>
                        </td>
                    </tr>
                    </tbody>
                </table>
