...
!function (n) {
    ...
    return n.ext.buttons.copyHtml5 = {
        ...
        action: function (t, e, o, s) {
            ...
            C("sheets sheet", B).attr("name", N(s)), s.autoFilter && (C("mergeCells", u).before(E(u, "autoFilter", {attr: {ref: "A" + F + ":" + z(i.header.length - 1) + a}})), C("definedNames", B).append(E(B, "definedName", {
                attr: {
